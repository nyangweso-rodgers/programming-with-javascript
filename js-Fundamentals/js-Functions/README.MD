...
- Remarks:
  ...
  - **Nestsed functions**: In `js`, a function can also contain another function.
...
- `Callback` is commonly used in JavaScript's **asynchronous** operations to provide synchronous functionality.
